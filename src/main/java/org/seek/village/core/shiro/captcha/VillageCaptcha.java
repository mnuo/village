 ...
 * 
 */
package org.seek.village.core.shiro.captcha;
...
import org.seek.village.core.utils.StringUtils;
import org.seek.village.core.utils.WebUtils;
 ...
 */
public class VillageCaptcha implements InitializingBean{
	private static Logger logger = LogManager.getLogger(VillageCaptcha.class);
	private static final String DEFAULT_COOKIE_NAME = "village-captcha";
	private final static String DEFAULT_CHACHE_NAME = "villageCaptchaCache";
	...
	private Cache<String, String> villageCaptchaCache;
	
	public VillageCaptcha() {
	...
	public void afterPropertiesSet() throws Exception {
		...
		this.villageCaptchaCache = cacheManager.getCache(cacheName);
	...
	public void generate(HttpServletRequest request, HttpServletResponse response) {
		...
		villageCaptchaCache.put(cookieValue, captchaCode);
	}
	/**
	 * 仅能验证一次，验证后立即删除
	...
	public boolean validate(HttpServletRequest request, HttpServletResponse response, String userInputCaptcha) {
		...
		String captchaCode = villageCaptchaCache.get(cookieValue);
		...
		if (result) {
			villageCaptchaCache.remove(cookieValue);
